...
function buscaMinas(array) {
    let arrayMinas = []; //Creación de la copia del array.
    ...
    for (let index = 0; index < arrayMinas.length; index++) {
        ...
        for (let subIndex = 0; subIndex < arrayMinas[index].length; subIndex++) { //Este for recorre el alrededor de cada posición con un "-1" y suma 1 esas posiciones.
...
console.log(`Buscaminas resuelto: `);
